---
title: "c/c++安全指南"
date: 2021-10-28T22:00:08+08:00
draft: false
image: 1.jpg
categories:
    - language
...
---
## 文章来源
 [鹅厂(腾讯)代码安全指南](https://github.com/Tencent/secguide)

## 通用安全指南
###  C/C++使用错误
####   【必须】不得直接使用无长度限制的字符拷贝函数
...
<a id="1.1.6"></a>
####   【必须】不应当把用户可修改的字符串作为printf系列函数的“format”参数
...
<a id="1.3.3"></a>
#### 【建议】注意Time-of-check Time-of-use (TOCTOU) 条件竞争
